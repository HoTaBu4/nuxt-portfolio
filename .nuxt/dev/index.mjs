...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/node-mock-http/dist/index.mjs';
import { prefixStorage } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/nitropack/node_modules/unstorage/dist/index.mjs';
import { createStorage } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/nuxt/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/node_modules/nitropack/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/volodimirdzibik/portfolio/nuxt-portfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/volodimirdzibik/portfolio/nuxt-portfolio","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/volodimirdzibik/portfolio/nuxt-portfolio/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/volodimirdzibik/portfolio/nuxt-portfolio/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/volodimirdzibik/portfolio/nuxt-portfolio/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/volodimirdzibik/portfolio/nuxt-portfolio/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/volodimirdzibik/portfolio/nuxt-portfolio/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _dUMKNs_DOPyHNL0nIkqoePnJ3VC2Ko3PBkc5Fpuo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/volodimirdzibik/portfolio/nuxt-portfolio";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A portfolio showcasing my projects and skills."}],"link":[],"style":[],"script":[],"noscript":[],"title":"My Portfolio"};
...
const _fc1mh_wlWCOFYrjaToT8CTrWvCdfRnsIun8BGx3_qio = (nitroApp) => {
...
const plugins = [
  _dUMKNs_DOPyHNL0nIkqoePnJ3VC2Ko3PBkc5Fpuo,
_fc1mh_wlWCOFYrjaToT8CTrWvCdfRnsIun8BGx3_qio
];
...
const _84vOwl = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _wNUdER = eventHandler(async (event) => {
  ...
  return await import('file:///Users/volodimirdzibik/portfolio/nuxt-portfolio/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const checksums = {
  "content": "v3.5.0--tc7byJgLwfdAteYNrYPjFoM7llxjLkcoEW-cFYnP-5Q"
};
...
const _niO362 = eventHandler(async (event) => {
...
const _lazy_o60Z3u = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _84vOwl, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_o60Z3u, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _wNUdER, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _niO362, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_o60Z3u, lazy: true, middleware: false, method: undefined }
];
